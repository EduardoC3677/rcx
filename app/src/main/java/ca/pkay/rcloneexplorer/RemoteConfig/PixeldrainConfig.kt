...
/**
 * Configuration fragment for Pixeldrain.
 * Pixeldrain is a file sharing service. Added in rclone 1.68.
 */
class PixeldrainConfig : Fragment() {
    ...
    companion object {
        @JvmStatic
        fun newInstance() = PixeldrainConfig()
    }
